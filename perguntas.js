criaCartao(
    'Artes',
    'Qual é a importância da originalidade na pintura? ',
    'A originalidade é essencial na pintura, pois é através dela que o artista consegue transmitir sua visão única do mundo. Cada pintor possui um estilo próprio e suas obras são como uma extensão de sua personalidade. '
)
...
criaCartao(
    ' Artes',
    ' Como a técnica da pintura pode influenciar as emoções transmitidas?',
    'A técnica utilizada pelo pintor também pode influenciar as emoções transmitidas pela obra de arte. Pinceladas rápidas e soltas podem transmitir energia e movimento, enquanto pinceladas suaves e delicadas podem transmitir tranquilidade e delicadeza. '
)
